...
for nu in range(24):
    for alpha in range(24):
        Fnnexp1[nu, alpha] =  np.sqrt(lista2[nu]/np.pi) * gaussianei(alpha, 1) * (expgw0wm(nu) + expgwowewm(alpha, nu)) * np.sqrt(Fnn1[nu, alpha]/np.pi)
...
#ax1.set_title(r"$e)$")
#ax1.text(0.15, 0.95, r'$e)$', transform=ax1.transAxes, fontsize=70, verticalalignment='top', horizontalalignment='right', color='white', bbox=None)
...
name_solutions = f'/home/christiandavid/Desktop/UCL_PhD/solutions_MO/solutions_MO_entangled_ss{ss}_{Modes}modes_{methodsolver}_{t0}to{t1}_dt{dt}_r0_nonsym_fsolverp.txt'

#Definition of the name of the file which contains the final row of the solutions
name_initial_conditions = f'/home/christiandavid/Desktop/UCL_PhD/initialconditions_MO/initial_conditions_MO_entangled_ss{ss}_{Modes}modes_{methodsolver}_{t0}to{t1}_dt{dt}_r0_nonsym_fsolverp.txt'

#Definition of the name of the file which contains the solution of the 25 first excited levels
name_populations = f'/home/christiandavid/Desktop/UCL_PhD/populations_MO/populations25_MO_entangled_ss{ss}_{Modes}modes_{methodsolver}_{t0}to{t1}_dt{dt}_r0_nonsym_fsolverp.txt'
