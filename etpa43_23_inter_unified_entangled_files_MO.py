...
Modes = 451 #Number of modes for the incoming field
...
Fnn = np.loadtxt('/home/christiandavid/Desktop/UCL_PhD/Ff_Factors_me_50_rev_1.txt')
...
name_solutions = f'/home/christiandavid/Desktop/UCL_PhD/inter_solutions_MO/inter_solutions_MO_{Modes}modes_{t0}to{t1}_dt{dt}_ss{ss}.npy'

#Save the total array of all solutions
np.save(name_solutions, psi1pm)

########################################
tii = np.linspace(t0, t1, np.shape(psi1pm)[0])


fig, ax1 = plt.subplots(figsize=(6, 17))
ax1.tick_params(direction='in', top = True, right = True, length=7)
plt.rcParams['font.size'] = '41'
for label in (ax1.get_xticklabels() + ax1.get_yticklabels()):
	label.set_fontsize(41)

plt.plot(tii, psi1pm_l_mod(0), color = "slateblue", label = r"$\nu = 0$")
plt.plot(tii, psi1pm_l_mod(1), color = "green", label = r"$\nu = 1$")
plt.plot(tii, psi1pm_l_mod(2), color = "darkcyan", label = r"$\nu = 2$")
plt.plot(tii, psi1pm_l_mod(3), color = "orange", label = r"$\nu = 3$")
plt.plot(tii, psi1pm_l_mod(4), color = "gold", label = r"$\nu = 4$")
plt.plot(tii, psi1pm_l_mod(5), color = "blue", label = r"$\nu = 5$")
plt.plot(tii, psi1pm_l_mod(6), color = "red", label = r"$\nu = 6$")
plt.plot(tii, psi1pm_l_mod(7), color = "black", label = r"$\nu = 7$")
plt.plot(tii, psi1pm_l_mod(8), color = "slateblue", label = r"$\nu = 8$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(9), color = "green", label = r"$\nu = 9$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(10), color = "darkcyan", label = r"$\nu = 10$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(11), color = "orange", label = r"$\nu = 11$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(12), color = "gold", label = r"$\nu = 12$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(13), color = "blue", label = r"$\nu = 13$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(14), color = "red", label = r"$\nu = 14$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(15), color = "black", label = r"$\nu = 15$", linestyle = "dashed")
plt.plot(tii, psi1pm_l_mod(16), color = "slateblue", label = r"$\nu = 16$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(17), color = "green", label = r"$\nu = 17$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(18), color = "deepskyblue", label = r"$\nu = 18$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(19), color = "orange", label = r"$\nu = 19$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(20), color = "gold", label = r"$\nu = 20$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(21), color = "blue", label = r"$\nu = 21$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(22), color = "red", label = r"$\nu = 22$", linestyle = "dashdot")
plt.plot(tii, psi1pm_l_mod(23), color = "black", label = r"$\nu = 23$", linestyle = "dashdot")
#plt.plot(tii, np.abs(lista1[:, -Nlevels + 24])**2, color = "purple", label = r"$\nu = 24$", linestyle = "dashdot")


plt.xlabel(r"$r \sigma $", fontsize=41)
plt.ylabel(r"$\langle m _{\nu} \rangle$", fontsize=41)
plt.legend(bbox_to_anchor=(0.03, 0.98), loc="upper left", fontsize=15, fancybox=True, framealpha=1, borderpad=1, edgecolor="black")
plt.subplots_adjust(left=0.24, bottom=0.115, right=0.979, top=0.95)
formatter = ScalarFormatter(useMathText=True)
formatter.set_powerlimits((-1, 2))  # Adjust these limits as needed
ax1.yaxis.set_major_formatter(formatter)
ax1.yaxis.offsetText.set_fontsize(41)
plt.text(-0.27, 1.0, r'$c)$', transform=ax1.transAxes, fontsize=41, fontweight='bold')
plt.show()    
